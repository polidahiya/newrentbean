...
function page() {
  return (
    <div className="p-[10px] md:p-[40px]">
      ...
      <h2 className="font-bold text-lg  mt-5 font-recline">
      ...
      <ul>
        <li className="list-disc text-sm  ml-[20px]">
      ...
      <h2 className="font-bold text-lg  mt-5 font-recline">2. Use of Information</h2>
      <p className="text-sm   ">
      ...
      <h2 className="font-bold text-lg  mt-5 font-recline">3. Data Security</h2>
      <p className="text-sm   ">
      ...
      <h2 className="font-bold text-lg  mt-5 font-recline">4. Data Sharing</h2>
      <p className="text-sm   ">
      ...
      <h2 className="font-bold text-lg  mt-5 font-recline">5. Legal Compliance</h2>
      <p className="text-sm   ">
        We may disclose your information when required by law or in response to
        lawful requests by public authorities, including to meet national
        security or law enforcement requirements.
      </p>
      <h2 className="font-bold text-lg  mt-5 font-recline">6. Consent</h2>
      <p className="text-sm   ">
      ...
      <h2 className="font-bold text-lg  mt-5 font-recline">8. Contact Us</h2>
      <p className="text-sm   ">
