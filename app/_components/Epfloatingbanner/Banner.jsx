    ...
    >
      ...
      <div className="flex-1 p-3 relative z-10">
        ...
        <p className="text-[8px] lg:text-[10px] opacity-75">
          From grand weddings to intimate gatherings, bring your vision to life
      ...
      <p className="absolute bottom-1 right-2 text-[12px] font-semibold text-slate-300 flex items-center gap-1">
        Sponsored{" "}
        <span className="h-2.5 aspect-square text-[8px] inline-flex items-center justify-center border rounded-full">
          i
        </span>
      </p>
    </Link>
